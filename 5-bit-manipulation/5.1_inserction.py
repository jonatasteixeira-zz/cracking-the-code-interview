...
def test():
    ...
    print(set_bits(bin1_str, bin2_str, 30, 38) == '11111111111111111111111111111100000000')
    print(set_bits(bin1_str, bin2_str, 0, 0) == '0000000011111111111111111111111111111111')
